...
async function run() {
    ...
    for (const item of allContent) {
        await prisma.landingContent.upsert({
            ...
            update: { title: item.title, content: item.content, items: item.items },
            create: { section: item.section, title: item.title, content: item.content, items: item.items },
        });
...
//# sourceMappingURL=seed_landing_content.js.map