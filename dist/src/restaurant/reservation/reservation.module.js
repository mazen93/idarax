...
exports.ReservationModule = ReservationModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [reservation_service_1.ReservationService, reservation_service_1.WaitingService],
        controllers: [reservation_controller_1.ReservationController, reservation_controller_1.WaitingController],
    })
], ReservationModule);
