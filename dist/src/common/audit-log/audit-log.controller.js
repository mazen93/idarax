...
let AuditLogController = class AuditLogController {
    ...
    findAll(req, userId, action, resourceType, from, to, page, limit) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve audit log entries for your tenant (managers only)' }),
...
exports.AuditLogController = AuditLogController = __decorate([
    ...
    (0, common_1.Controller)('analytics/audit-log'),
